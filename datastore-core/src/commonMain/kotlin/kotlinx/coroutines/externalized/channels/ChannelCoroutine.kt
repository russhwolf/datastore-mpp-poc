...
package kotlinx.coroutines.externalized.channels

import kotlinx.coroutines.*
import kotlinx.coroutines.channels.Channel
import kotlinx.coroutines.externalized.JobCancellationException
...
internal open class ChannelCoroutine<E>(
    ...
    /* internal from superclass */
    private inline fun defaultCancellationException() =
        JobCancellationException(this)
